            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Laporan Keuntungan Global</h1>
                    </div>
                </div>
            </div>
        </div>
                  ...
                  <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Data Laporan Keuntungan Global</strong>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <!-- <div class="col-md-3">
          ...
          dataType:"json",
              success:function(response)
              {
                ...
                tabeldata = $("#mytable").DataTable({
                      ...
                      ajax: {
                    "type"   : "POST",
                    "url"    : "<?php echo base_url('superadminfranchise/datalaporankeuntunganglobal');?>",
                    "data": function(d){
                    ...
                    buttons: [
                        {
                            ...
                            filename: function (argument) {
                                  ...
                                  return 'Keuntungan Global'+" bulantahun "+tanggall ;
                            } ,
                            exportOptions: {
                              columns:[0,1,2,3,4]
                            }
